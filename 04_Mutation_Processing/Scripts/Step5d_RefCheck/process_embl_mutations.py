...
BASE_DIR   = os.path.normpath(os.path.join(_SCRIPT_DIR, '..', '..', 'Mutation Extraction and Matching'))
INPUT_XLSX = os.path.normpath(os.path.join(_SCRIPT_DIR, '..', '..', '..', '02_Source_Database', 'IDBases_Summary_with_UniProt.xlsx'))
