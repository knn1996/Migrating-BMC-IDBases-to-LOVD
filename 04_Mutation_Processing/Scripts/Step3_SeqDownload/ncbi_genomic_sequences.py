...
CSV_OUT    = r"C:\Users\BornLoser\Desktop\Assignment\Thesis\04_Mutation_Processing\Scripts\Step3_SeqDownload\ncbi_genomic_sequences.csv"
...
def main():
    ...
    df_valid = df.dropna(subset=["name"]).drop_duplicates(subset=["name"])
    genes = df_valid["name"].str.strip().tolist()
