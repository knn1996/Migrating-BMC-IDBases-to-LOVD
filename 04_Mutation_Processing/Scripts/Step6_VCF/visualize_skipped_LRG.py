...
OUTPUT_DIR  = os.path.join(SCRIPTS_DIR, "..", "Output", "Step6_VCF")
TSV_PATH    = os.path.join(OUTPUT_DIR, "bed_to_vcf_skipped_source_1.tsv")
OUTPUT_HTML = os.path.join(OUTPUT_DIR, "bed_to_vcf_skipped_source_1_dashboard.html")
